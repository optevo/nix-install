...
# 2. Search and replace the placeholder in the nix file
# (The -i '' is specifically for macOS's version of sed)
sed -i '' "s/AUTOGENERATED_USER_PLACEHOLDER/$REAL_USER/g" "darwin-configuration.nix"
